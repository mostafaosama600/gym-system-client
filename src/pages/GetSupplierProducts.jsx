...
export default function GetSupplierProducts() {
  ...
  const {
    ...
    `Products/GetSupplierProducts?start=${(page - 1) * 10}&count=10`
  );
  ...
  return (
    <div className="container">
      <div className="mb-3 rtl-products" id={`${styles.item1}`}>
        <h5 className="card-title mt-3">منتجات الموردين</h5>
      </div>
      {isLoading ? (
        <Loader />
      ) : isError ? (
