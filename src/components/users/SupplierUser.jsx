...
import { registerSupplierSchema } from "../../schemas/Schemes";
...
export default function Supplier() {
  ...
  }Authentication/SupplierRegister`;

  const { handleSubmit, isLoading, isError, errorList, userExistError } =
    useRegister(user, registerSupplierSchema, apiUrl);
  ...
  return (
    <div className="container border-top">
      <form className="row g-3 mt-2" onSubmit={handleSubmit}>
        ...
        <div className="col-md-3">
          <label className="form-label text-dark">المنطقة</label>
          <input
            type="text"
            className="form-control border"
            name="region"
